...
the rest fill two to a row. The tall one is white with a soft blue glow rising from its foot; all quotes are 17px regular with 1.7 leading, cells padded 56px; avatars are soft pastel discs with ink initials. The cells sit inside
