...
the rest fill two to a row. The tall one carries the hero gradient flipped and lightened, pale yellow at the top
  into soft sky at the foot, near-white through the middle; all quotes are 17px regular with 1.7 leading, cells padded 56px; avatars are soft pastel discs with ink initials. The cells sit inside
