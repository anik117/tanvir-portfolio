...
the rest fill two to a row. The tall one carries the hero sheet's sky-to-yellow gradient; all quotes are 17px regular with 1.7 leading, cells padded 56px; avatars are soft pastel discs with ink initials. The cells sit inside
