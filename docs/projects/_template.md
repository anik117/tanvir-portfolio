...
Copy this file to `docs/projects/<slug>.md` and fill it in. Delete this line.
...
Do not claim an outcome without evidence behind it. An unbacked metric is the first thing a
design leader will probe.
