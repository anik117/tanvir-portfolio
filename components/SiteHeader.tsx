      ...
      <div className="mx-auto flex h-16 max-w-page items-center justify-between gap-4 px-6">
        <div className="flex items-center gap-3">
          ...
          {availability && (
            ...
            <span className="availability hidden items-center gap-1.5 rounded-md border border-border bg-surface px-2 py-1 text-[11px] font-medium text-muted sm:inline-flex">
